...
public class Customer {
	...
	/*
	 * We assign the relantionship here.. This is many to many 
	 * many customers can shop at many pet stores
	 */
	@EqualsAndHashCode.Exclude
	@ToString.Exclude  //takes care of the recursion but not sure how
	@ManyToMany(mappedBy = "customers", cascade = CascadeType.PERSIST) //remember this creates another table!!! this table will help create 
	//the many to many 
